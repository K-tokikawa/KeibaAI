...
export default class MgrRaceData{
    ...
    private m_dic: {
        [RaceID: number]:{
            [HorseID: number]: {
                [num: number]: {PassageData: string, AchievementData: string, RotationData: string}
            }
        }
    }
    ...
    async dicCreate(valueblood: EntBloodStudyData_Blood[]){
        const dic: {
            [RaceID:number]:{
                [HorseID: number]: {
        ...
        this.m_RaceData.forEach((row: EntRaceHorseStudyData) => {
            ...
            if (dicHorse[HorseID] == undefined) {
                this.m_dic[RaceID][HorseID] ={}
                dicHorse[HorseID] = {}
            }
            this.m_dic[RaceID][HorseID][num] = {PassageData: '', AchievementData: '', RotationData: ''}
            ...
            Object.keys(dicHorse).forEach(keyHorseID => {
                ...
                Object.keys(entitys).forEach(keynum => {
                    ...
                    if (RaceHorseData.length > 1) {
                        ...
                        this.m_dic[RaceID][HorseID][num].RotationData = data
                    }
                    ...
                    this.m_RaceData.forEach((row: EntRaceHorseStudyData) => {
                        ...
                        this.m_dic[RaceID][HorseID][num].AchievementData = strPassage
                    ...
                    Object.keys(entitys).forEach(key => {
                        ...
                        this.m_dic[RaceID][HorseID][num].AchievementData = strAchievement
                    })
                })
            })
        })
